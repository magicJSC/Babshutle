...
public class UI_Main : UI_Base
{
    ...
    private void Start()
    {
        ...
        e.OnClick += (PointerEventData evt) => { Managers.Data.Init(); GetComponent<Animator>().Play("ChangeScene"); c1.GetComponent<AudioSource>().PlayOneShot(Resources.Load<AudioClip>("Sound/Click")); };   //설명 : 전체 대화 -> 타임라인 이벤트
